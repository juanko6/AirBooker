...
CREATE TABLE `aerolineas` (
  ...
  `paisOrigen` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contacto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sitio_web` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `urlLogo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `carrito_items` (
  ...
  KEY `carrito_items_vuelo_id_foreign` (`vuelo_id`),
  CONSTRAINT `carrito_items_carrito_id_foreign` FOREIGN KEY (`carrito_id`) REFERENCES `carritos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `carrito_items_vuelo_id_foreign` FOREIGN KEY (`vuelo_id`) REFERENCES `vuelos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `ofertas` (
  ...
  `ProcentajeDescuento` decimal(5,2) NOT NULL,
  `estado` enum('Activa','Inactiva','Vencida') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `reservas` (
  ...
  KEY `reservas_vuelo_id_foreign` (`vuelo_id`),
  CONSTRAINT `reservas_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `reservas_vuelo_id_foreign` FOREIGN KEY (`vuelo_id`) REFERENCES `vuelos` (`id`) ON DELETE CASCADE
...
CREATE TABLE `users` (
  ...
  `pasaporte` varchar(9) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email_verified_at` timestamp NULL DEFAULT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `telefono` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rol` enum('Administrador','Cliente') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  UNIQUE KEY `users_pasaporte_unique` (`pasaporte`),
...
CREATE TABLE `vuelos` (
  ...
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
  `horaFinVuelo` time DEFAULT NULL,
  `duracionDelViaje` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `origen` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `destino` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `precio` decimal(8,2) NOT NULL,
  `clase` enum('Primera Clase','Ejecutiva','Económica') COLLATE utf8mb4_unicode_ci NOT NULL,
  `urlImgDestino` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `vuelos_oferta_id_foreign` (`oferta_id`),
  CONSTRAINT `vuelos_aerolinea_id_foreign` FOREIGN KEY (`aerolinea_id`) REFERENCES `aerolineas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `vuelos_oferta_id_foreign` FOREIGN KEY (`oferta_id`) REFERENCES `ofertas` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2025-04-14 22:28:06
